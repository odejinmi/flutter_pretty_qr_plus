...
import '../pretty_qr_code_plus.dart';

class PrettyQrPlus extends StatefulWidget {
  ///Widget size
  final double size;
  ...
  @override
  _PrettyQrPlusState createState() => _PrettyQrPlusState();
}

class _PrettyQrPlusState extends State<PrettyQrPlus> {
